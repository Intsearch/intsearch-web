            ...
            <div className="modal-box">
                ...
                <div className="collapse collapse-open">
                    ...
                    <div className="collapse-content text-sm">
                        ...
                        <label className="input w-full ps-4 mt-3">
                            ...
                            <input type="text" value={params?.ai?.base?.key || ''} onChange={e => setParams(old => ({
                                ...old,
                                ai: {
                                    ...old.ai,
                                    base: {
                ...
                <div className="collapse collapse-open">
                    ...
                    <div className="collapse-content text-sm">
                        <label className="select w-full">
                            <span className="label">模型提供方</span>
                            <select value={params?.ai?.thinking?.provider || ''} onChange={e => setParams(old => ({
                                ...old,
                                ai: {
                                    ...old.ai,
                                    thinking: {
                        ...
                        <label className="input w-full ps-4 mt-3">
                            <span className="label">模型名字</span>
                            <input type="text" list="model_list_thinking" value={params?.ai?.thinking?.model || ''}
                                   onChange={e => setParams(old => ({
                                       ...old,
                                       ai: {
                                           ...old.ai,
                ...
                <div className="collapse collapse-open">
                    ...
                    <div className="collapse-content text-sm">
                        <label className="input w-full ps-4">
                            <span className="label">API Key</span>
                            <input type="text" value={params?.search?.key || ''} onChange={e => setParams(old => ({
                                ...old,
                                search: {
                                    ...old.search,
                                    key: e.target.value
                        ...
                        <label className="input w-full ps-4 mt-3">
                            ...
                            <input type="text" value={params?.search?.cx || ''} onChange={e => setParams(old => ({
                                ...old,
                                search: {
                                    ...old.search,
                                    cx: e.target.value
